...
export function HomePage() {
  ...
  useEffect(() => {
    document.title = `${env.KIE_SANDBOX_APP_NAME} :: 首页`;
  ...
  return (
    <OnlineEditorPage>
        ...
        <Grid hasGutter style={{ minWidth: "1280px", gridGap: "var(--pf-c-page__main-section--PaddingTop)" }}>
          <GridItem span={6}>
            <PageSection variant={"light"} isFilled={true} style={{ height: "100%" }}>
              <TextContent>
                <Text component={TextVariants.h1}>创建</Text>
              </TextContent>
              <br />
          ...
          <GridItem span={6}>
            <PageSection variant={"light"} isFilled={true} style={{ height: "100%" }}>
              <TextContent>
                <Text component={TextVariants.h1}>导入</Text>
              </TextContent>
              <br />
              <Divider inset={{ default: "insetXl" }} />
              <Gallery
      ...
      <PageSection isFilled={true} variant={"light"} hasOverflowScroll={true} aria-label="工作区区域">
        <PromiseStateWrapper
          promise={workspaceDescriptorsPromise}
          rejected={(e) => <>获取工作区时出错: {e + ""}</>}
          resolved={(workspaceDescriptors) => {
            return (
              <Drawer isExpanded={!!expandedWorkspaceId} isInline={true}>
                <DrawerSection>
                  <TextContent>
                    <Text component={TextVariants.h1}>最近的模型</Text>
                  </TextContent>
                  <br />
                </DrawerSection>
                <DrawerContent
                    ...
                    {workspaceDescriptors.length === 0 && (
                      <Bullseye>
                        <EmptyState>
                          ...
                          <EmptyStateBody>{"通过添加新模型开始"}</EmptyStateBody>
                        </EmptyState>
                      </Bullseye>
                    )}
                  </DrawerContentBody>
              ...
              <CardTitle>
                <TextContent>
                  <Text component={TextVariants.h3}>
                    ...
                    &nbsp;&nbsp;
                    {"获取工作区 '" + props.workspace.workspaceId + "' 信息时出错"}
                  </Text>
                </TextContent>
              </CardTitle>
            </FlexItem>
                  ...
                  <DeleteDropdownWithConfirmation
                    ...
                    item={
                      <Flex flexWrap={{ default: "nowrap" }}>
                        <FlexItem>
                          删除 <b>{`"${editableFiles[0].nameWithoutExtension}"`}</b>
                        </FlexItem>
                        <FlexItem>
                          <b>
        ...
        <>
          <DrawerHead>
            <Flex>
              <FlexItem>
                <TextContent>
                  <Text component={TextVariants.h3}>{"在 '" + workspace.descriptor.name + "' 中的模型"}</Text>
                </TextContent>
              </FlexItem>
              <FlexItem>
                <ResponsiveDropdown
