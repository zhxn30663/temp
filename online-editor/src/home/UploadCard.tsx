  ...
  return (
    <div {...getRootProps()} className={"dropzone"} style={{ position: "relative" }}>
      {(isDragActive || uploading === UploadType.DND) && (
        ...
        >
          ...
          {isDragActive && (
            <Bullseye>
              <TextContent>
                <Text component={TextVariants.h3}>上传 {draggedFiles.length} 个项目。</Text>
              </TextContent>
            </Bullseye>
          )}
        </div>
      ...
      <Card isFullHeight={true} isLarge={true} isPlain={true}>
        ...
        <CardBody>
          <TextContent>
            <Text component={TextVariants.p}>拖放文件和文件夹到此处...</Text>
          </TextContent>
        </CardBody>
        <CardFooter>
          <Split isWrappable={false} style={{ alignItems: "center" }}>
            ...
            <SplitItem style={{ padding: "0 16px 0 16px", color: "gray" }}>或</SplitItem>
            <SplitItem isFilled={true}>
              <Divider />
            </SplitItem>
          </Split>
