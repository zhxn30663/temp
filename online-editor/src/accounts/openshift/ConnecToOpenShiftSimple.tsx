      ...
      <Form>
        ...
        >
          <InputGroup className="pf-u-mt-sm">
            ...
            />
            <InputGroupText>
              <Button isSmall variant="plain" aria-label="清除命名空间按钮" onClick={onClearNamespace}>
                <TimesIcon />
              </Button>
            </InputGroupText>
          </InputGroup>
        ...
        >
          <InputGroup className="pf-u-mt-sm">
            ...
            />
            <InputGroupText>
              <Button isSmall variant="plain" aria-label="清除主机按钮" onClick={onClearHost}>
                <TimesIcon />
              </Button>
            </InputGroupText>
          </InputGroup>
        ...
        >
          <InputGroup className="pf-u-mt-sm">
            ...
            />
            <InputGroupText>
              <Button isSmall variant="plain" aria-label="清除令牌按钮" onClick={onClearToken}>
                <TimesIcon />
              </Button>
            </InputGroupText>
          </InputGroup>
        ...
        <ActionGroup>
          <Button
            ...
            spinnerAriaValueText={isConnecting || props.isLoadingService ? "加载中" : undefined}
          >
            {isConnecting || props.isLoadingService ? "连接中" : "连接"}
          </Button>
        </ActionGroup>
      </Form>
    </>
