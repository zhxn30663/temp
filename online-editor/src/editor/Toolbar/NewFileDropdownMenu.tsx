          ...
          <MenuItem
            ...
            drilldownMenu={
              <DrilldownMenu id={"samplesMenu"}>
                <MenuItem direction="up">返回</MenuItem>
                <Divider />
              ...
              <DrilldownMenu id={"importFromUrlMenu"}>
                ...
                <MenuInput onKeyDown={(e) => e.stopPropagation()}>
                  <ImportSingleFileFromUrlForm
                    authSessionSelectHelperText={`在此更改不会在 '${props.workspaceDescriptor.name}' 上更改它`}
