  ...
  return (
    <OnlineEditorPage onKeyDown={onKeyDown}>
      <PromiseStateWrapper
        ...
        rejected={(errors) => (
          <EditorPageErrorPage title="无法打开文件" errors={errors} path={props.fileRelativePath} />
        )}
        resolved={(file) => (
            ...
            <Page>
              ...
              >
                ...
                >
                  ...
                  <Divider />
                  <PageSection hasOverflowScroll={true} padding={{ default: "noPadding" }} aria-label="编辑器部分">
                    <DmnRunnerDrawer>
