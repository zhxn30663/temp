...
export function useImportableUrl(urlString?: string, allowedUrlTypes?: UrlType[]): ImportableUrl {
  ...
  return useMemo(() => {
    if (!urlString) {
      return { type: UrlType.INVALID, error: "URL为空" };
    }
    ...
    try {
      ...
      return { type: UrlType.INVALID, error: "无效的URL" };
    }
    ...
    if (url.host === "github.com") {
      ...
      return { type: UrlType.NOT_SUPPORTED, error: "不支持的GitHub URL", url };
    }
    ...
    if (url.host === "bitbucket.org") {
      ...
      return { type: UrlType.NOT_SUPPORTED, error: "不支持的Bitbucket URL", url };
    }
    ...
    if (url.host === "raw.githubusercontent.com") {
      ...
      return { type: UrlType.NOT_SUPPORTED, error: "不支持的GitHub原始URL", url };
    }
    ...
    if (url.host === "gist.github.com" || url.host === "gist.githubusercontent.com") {
      ...
      if (!gistMatch && !rawGistMatch && !directGistMatch) {
        return { type: UrlType.NOT_SUPPORTED, error: "不支持的Gist URL", url };
      }
