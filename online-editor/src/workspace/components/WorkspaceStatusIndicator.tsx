  ...
  const indicatorTooltip = React.useMemo(() => {
    ...
    const tooltipForStageStatus = (stageStatus?: FileModificationStatus) => {
      const modifiedTooltip = (
        <Tooltip content={"已修改"} position={"bottom"}>
          <small>
            <i>M</i>
          </small>
        </Tooltip>
      ...
      const deletedTooltip = (
        <Tooltip content={"已删除"} position={"bottom"}>
          <small>
            <i>D</i>
          </small>
        </Tooltip>
      ...
      const addedTooltip = (
        <Tooltip content={"已添加"} position={"bottom"}>
          <small>
            <i>A</i>
          </small>
        </Tooltip>
        ...
        switchExpression(resolveGitSyncStatus(props.gitStatusProps.workspaceGitStatusPromise?.data ?? prev), {
          pending: (
            <Title headingLevel={"h6"} style={{ display: "inline", cursor: "default" }}>
              <Tooltip content={`自您上次同步以来有新的更改。`} position={"bottom"}>
                <small>
          ...
          synced: (
            <Title headingLevel={"h6"} style={{ display: "inline", cursor: "default" }}>
              <Tooltip content={`所有文件已同步。`} position={"bottom"}>
                <small>
          ...
          unknown: (
            <Title headingLevel={"h6"} style={{ display: "inline", cursor: "default" }}>
              <Tooltip content={"检查状态中..."} position={"right"}>
                <small>
