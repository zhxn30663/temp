...
const bpmnLabel: LabelColorType = { color: "green", label: "工作流" };
const dmnLabel: LabelColorType = { color: "blue", label: "决策" };
const pmmlLabel: LabelColorType = { color: "purple", label: "计分卡" };
