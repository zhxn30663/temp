                ...
                <Form>
                  <FormGroup label={"Model"} isRequired={true}>
                    <Select
                      ...
                      typeAheadAriaLabel={"选择要包含的模型..."}
                      placeholderText={"选择要包含的模型..."}
  ...
  return (
    <Card isHoverable={true} isCompact={false}>
      ...
      {externalModel ? (
        ...
        // unknown
        <CardBody>
          <Alert title={"未找到外部模型。"} isInline={true} variant={AlertVariant.danger}>
