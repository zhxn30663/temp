...
export function ContentField(props: {
  ...
  return <TextField {...props} type={TextFieldType.TEXT_AREA} title="内容" placeholder="请输入内容..." />;
}
...
export function DescriptionField(props: {
  ...
  return (
    <TextField {...props} type={TextFieldType.TEXT_AREA} title="描述" placeholder="请输入描述..." />
  );
}
    ...
    <FormGroup label={props.title}>
      {props.type === TextFieldType.TEXT_AREA && (
        <TextArea
          ...
          placeholder={props.placeholder ?? "请输入表达式内容..."}
